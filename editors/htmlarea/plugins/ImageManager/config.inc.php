...
*/
$IMConfig['base_dir'] = dirname(dirname(dirname(dirname(dirname(__FILE__))))) . '/images/htmlarea';
...
*/
$IMConfig['base_url'] = '/images/htmlarea';
...
*/
$IMConfig['thumbnail_width'] = 100;
$IMConfig['thumbnail_height'] = 50;
