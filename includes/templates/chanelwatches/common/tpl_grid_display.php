...
if($row <= 3 && $_GET['page'] < 1){
	$li_grid_bg = 'class="li_grid_bg"';
}else{
	$li_grid_bg="";
}
?>
<li <?php echo $li_grid_bg;?>>
...
<div class="line_180" align="center"><strong>Our Price: </strong>
<?php
...
<div>Compare at: <?php echo $list_box_contents[$row]['products_price_retail'];?></div>
</div>
