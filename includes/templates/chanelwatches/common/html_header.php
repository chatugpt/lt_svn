...
<meta name="author" content="Mazentop.com Team and others" />
 ...
 */
  ...
  *
  */
  $onlycss = $template->get_template_dir('.css', DIR_WS_TEMPLATE, $current_page_base, 'css') . '/only.css';
  if(isset($_GET['c']) && $_GET['c'] == 'only' && file_exists($onlycss)) {
  echo '<link type="text/css" rel="stylesheet" href="'.$onlycss.'" />';
  }
  /**
/**
