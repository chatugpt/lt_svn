...
{
	document.getElementById('verifycode').src="<?php //echo DIR_WS_TEMPLATE;?>tpl_img.php?random="+Math.random(); 
}
</script>
<?php
...
?>
<input name="txtCode" type="text" id="txtCode" size="10"/><img src="tpl_img.php" id="verifycode" onclick="refreshVerifyCode();"/><br class="clear" />
<?php //echo $_SESSION["IMGVER_RndText"]; ?>
