...
Please make sure that the telephone number you typed is correct, during the shipping process, the shipping company might contact you for the delivery. For your security, we may need to contact you at a verified phone number before your order ships. <a target="_blank" href="<?php echo zen_href_link(FILENAME_PRIVACY); ?>">view our privacy policy.</a></div>
</td></tr>
<?php
