...
<h1  class="border_b line_30px pad_l_10px"><?php echo TEXT_AVAILABLE_BALANCE;?></h1>
...
<div class="pad_10px fr"><a href="<?php echo zen_href_link(FILENAME_SHOPPING_CART, 'shopping_cart', 'SSL', false); ?>"><?php echo zen_image_button(BUTTON_IMAGE_CONTINUE, BUTTON_CONTINUE_ALT); ?></a></div>
<!--EOF GV sent success -->
<?php
  }
