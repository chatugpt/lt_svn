...
//
echo zen_draw_form('form123', zen_href_link(FILENAME_FAQS_SUBMIT, '', 'SSL'), 'post', 'enctype="multipart/form-data" onSubmit="return(fmChk(this))"');
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="plainBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="2" cellpadding="2">
                ...
                <td><?php echo zen_draw_input_field('fullname', $name ,' class="input_box" chkname="Your Name" chkrule="nnull"'); ?></td>
              </tr>
			                <tr>
                ...
                <td><?php echo zen_draw_input_field('sEmail', $email,' class="input_box" chkname="Email" chkrule="nnull/eml" id="sEmail"'); ?></td>
              </tr>
              <tr>
              	<td></td>
			  ...
			  <tr>
                ...
                <td><?php echo zen_draw_input_field('faqs_name','',' class="input_box"  chkname="Question Title" chkrule="nnull"'); ?></td>
              </tr>
              <tr>
...
?>
              ...
              <tr>
                ...
                <td><?php echo zen_draw_textarea_field('faqs_description', 25, 5,'',' class="textarea1" chkname="Write a inquiry" chkrule="nnull/max10000"') ; ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td align="right" style="padding-right:40px;"><?php echo zen_image_submit(BUTTON_IMAGE_SUBMIT, IMAGE_BUTTON_SUBMIT); ?></td>
                <td width="10"><?php echo zen_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
            </table></td>
          </tr>
