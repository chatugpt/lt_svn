...
<div class="right_big_con  allborder margin_t" style="padding: 5px;">
...
<div class="fr"><?php echo '<a href="javascript:popupWindow(\'' . zen_href_link(FILENAME_POPUP_SEARCH_HELP) . '\')">' . TEXT_SEARCH_HELP_LINK . '</a>'; ?></div>
<br class="clear" />
...
<div class="buttonRow fr"><?php echo zen_image_submit(BUTTON_IMAGE_SEARCH, BUTTON_SEARCH_ALT); ?></div>
<div class="buttonRow fl"><?php echo zen_back_link() . zen_image_button(BUTTON_BACK_ALT, BUTTON_BACK_ALT) . '</a>'; ?></div>
