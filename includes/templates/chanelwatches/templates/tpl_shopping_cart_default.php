...
<?php
  ...
  echo '<ul>';
    ...
    foreach ($product['attributes'] as $option => $value) {
	  $products_options_name = isset($value['products_options_name']) ? $value['products_options_name'] : $option;
...
?>
      ...
      ?>
      <div style="display: none;"><a onclick="$_('cart_quantity').submit();return false;" href="javascript:void(0);">Update</a>|<a href="<?php echo $_SERVER['REQUEST_URI']?>">Cancel</a></div>
       </li>
...
<li class="g_t_c" style="padding-left: 380px;"><?php echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '" class="buttonCheakout"></a><br/>'; ?><!-- * BEGIN GOOGLE CHECKOUT * -->
 <?php
  // ** GOOGLE CHECKOUT **
...
<iframe width="98%" scrolling="no" height="300" frameborder="0" src="?php echo zen_href_link(FILENAME_SHIPPING_ESTIMATOR); ?>" style="display:;" id="shipping_estimator_frm"></iframe>-->
...
<?php
  require(DIR_WS_MODULES.zen_get_module_directory('recently_viewed.php'));
?>