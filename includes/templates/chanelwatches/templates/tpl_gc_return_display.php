...
<table class="cartContentsDisplay" width="100%" cellspacing="0" cellpadding="1" border="0">
  <tr valign="top">
    <td valign="top" align="center"><h2 id="productPrices" class="productGeneral"><?php echo TEXT_THANK_YOU;?></h2></td>
  </tr>
  <tr valign="top">
  ...
  <tr valign="top" class="tableHeading">
    <td class="scQuantityHeading"><h2 id="productPrices" class="productGeneral"><?php echo TEXT_JUST_BOUGHT;?></h2></td>
  </tr>
...
?>
  <tr valign="top">
    <td class="rowEven"><h1 id="productName" class="productGeneral"><?php echo $products_name;?></h1></td>
  </tr>
<?php } ?>
<!--eof Product Name-->
</table>
