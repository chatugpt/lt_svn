...
<?php } else { ?>
  <table border="0" cellspacing="0" cellpadding="0" id="table_info">
    <tr>
      ...
      <?php if($products_discount_type ==1) {?><th align="center">Discount</th><?php }?>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <?php if($products_discount_type ==1) {?><td align="center"> No</td><?php }?>
    </tr>
...
<?php if($products_discount_type ==1) {?><td><?php echo $quantityDiscount['discount'] ?></td><?php }?>
<?php
    $disc_cnt++;
