...
<?php for ($i=1, $n=sizeof($var_linksList); $i<=$n; $i++) { 
  ...
  ?>  
  <?php if (($current_page == $current_link && empty($_GET['id'])) || (!empty($_GET['id']) && $_GET['id'] == $var_linksList[$i]['id'])){ ?>
  <li class="<?php echo 'li'.$i; ?>"><span><a style="color:#A72D2C;" href="<?php echo $var_linksList[$i]['link']; ?>"><?php echo $var_linksList[$i]['name']; ?></a></span></li>
  <?php }else{ ?>
