...
?>
<fieldset  class="dark_border">
<legend><b><?php echo TEXT_NOTIFY_PRODUCTS; ?></b></legend>
...
<br />
<?php } ?>
<div class="fr"><?php echo zen_image_submit(BUTTON_IMAGE_UPDATE, BUTTON_UPDATE_ALT); ?></div>
</form>
</fieldset>
<?php
    }
...
<?php  require(DIR_WS_MODULES.zen_get_module_directory('recently_viewed.php'));?>