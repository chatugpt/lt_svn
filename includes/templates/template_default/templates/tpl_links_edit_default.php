...
//
  ...
  $owns_link = $db->Execute("select links_id, links_owner from " . TABLE_LINKS . " where links_id = '" . $links_id . "'");
  if (($_SESSION['customer_id']) == ($owns_link->fields['links_owner'])) { 
  echo zen_draw_form('submit_link', zen_href_link(FILENAME_LINKS_EDIT, 'links_id=' . $links_id), 'post', 'onSubmit="return check_form(submit_link);"') . zen_draw_hidden_field('action', 'process'); ?>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td class="main"><?php echo zen_draw_input_field('links_title', $linkd->fields['links_title']) . '&nbsp;' . (zen_not_null(ENTRY_LINKS_TITLE_TEXT) ? '<span class="inputRequirement">' . ENTRY_LINKS_TITLE_TEXT . '</span>': ''); ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo ENTRY_LINKS_URL; ?></td>
                <td class="main"><?php echo zen_draw_input_field('links_url', $link->fields['links_url']) . '&nbsp;' . (zen_not_null(ENTRY_LINKS_URL_TEXT) ? '<span class="inputRequirement">' . ENTRY_LINKS_URL_TEXT . '</span>': ''); ?></td>
              </tr>
<?php
...
?>
              ...
              <tr>
                ...
                <td class="main"><?php echo zen_draw_textarea_field('links_description', 'soft', 25, 5, $linkd->fields['links_description']) . '&nbsp;' . (zen_not_null(ENTRY_LINKS_DESCRIPTION_TEXT) ? '<span class="inputRequirement">' . ENTRY_LINKS_DESCRIPTION_TEXT . '</span>': ''); ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo ENTRY_LINKS_IMAGE; ?></td>
                <td class="main"><?php echo zen_draw_input_field('links_image', $link->fields['links_image_url']) . '&nbsp;' . (zen_not_null(ENTRY_LINKS_IMAGE_TEXT) ? '<span class="inputRequirement">' . ENTRY_LINKS_IMAGE_TEXT . '</span>': ''); ?><?php echo '<a href="javascript:popupWindow(\'' . zen_href_link(FILENAME_POPUP_LINKS_HELP) . '\')">' . TEXT_LINKS_HELP_LINK . '</a>'; ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
          ...
          <tr class="infoBoxContents">
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td class="main"><?php echo zen_draw_input_field('links_contact_name', $link->fields['links_contact_name']) . '&nbsp;' . (zen_not_null(ENTRY_LINKS_CONTACT_NAME_TEXT) ? '<span class="inputRequirement">' . ENTRY_LINKS_CONTACT_NAME_TEXT . '</span>': ''); ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo ENTRY_EMAIL_ADDRESS; ?></td>
                <td class="main"><?php echo zen_draw_input_field('links_contact_email', $link->fields['links_contact_email']) . '&nbsp;' . (zen_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="inputRequirement">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>': ''); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
          ...
          <tr class="infoBoxContents">
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td class="main"><?php echo zen_draw_input_field('links_reciprocal_url', $link->fields['links_reciprocal_url']) . '&nbsp;' . (zen_not_null(ENTRY_LINKS_RECIPROCAL_URL_TEXT) ? '<span class="inputRequirement">' . ENTRY_LINKS_RECIPROCAL_URL_TEXT . '</span>': ''); ?><?php echo '<a href="javascript:popupWindow(\'' . zen_href_link(FILENAME_POPUP_LINKS_HELP) . '\')">' . TEXT_LINKS_HELP_LINK . '</a>'; ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
...
<?php 	
    ...
    <td class="pageHeading" colspan="2"><h1><?php echo HEADING_TITLE; ?></h1></td>
	  ...
	  <tr>
        <td><?php echo NO_EDIT_LINK_PERMISSIONS; ?></td>
      </tr>
	  </table>	
 <?php  } ?>