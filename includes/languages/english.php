...
//These Constant addBy shOwQ
	...
	define('SEO_COMMON_KEYWORDS','Supply');
...
// javascript messages
  ...
  define('ENTRY_HOW_DID_YOU_KNOW', 'How did you know '. STORE_NAME .'?');
...
define('BASE_COMMON_TEXT_REGISTER', 'Register');
define('BASE_COMMON_TEXT_SIGNIN', 'Sign in');
define('BASE_COMMON_TEXT_LOGOUT', 'Logout');
define('BASE_COMMON_TEXT_OR', 'or');
define('BASE_COMMON_TEXT_WELCOME', 'Welcome');
define('BASE_COMMON_TEXT_ALL_CATEGORY', 'All Categories');
define('BASE_COMMON_TEXT_ASK', 'Ask a question?');
define('BASE_COMMON_TEXT_FEATURED_CATEGORIES', 'Featured Categories');
define('BASE_COMMON_TEXT_MORESUPPLYPRODUCTS', 'More supply products >');
define('BASE_COMMON_TEXT_SHOPPINGBYCATEGORIES', 'Shopping by Categories');
define('BASE_COMMON_TEXT_ONLINEBUY', 'Online buy cheapest products direct from Chinese supply at lightinthebox.com');
define('BASE_COMMON_TEXT_SHIPTO', 'ship to');
define('BASE_COMMON_TEXT_MOREWHOLESALEPRODUCTS', 'More wholesale products');
define('BASE_COMMON_TEXT_MOREINFOABOUT', 'More Info About');
define('BASE_COMMON_TEXT_RELATEDCATEGORIES', 'Related Categories');
define('BASE_COMMON_TEXT_TOPSELLINGIN', 'Top Selling in ');
define('BASE_COMMON_TEXT_IFHAVEANACCOUNT', 'If you have an account, please Login.');
define('BASE_COMMON_TEXT_PLEASEAGREETOOUR', 'Please agree to our <a class="red u" target="_blank" href="'.zen_href_link(FILENAME_PRIVACY).'">Terms and Conditions</a>');
define('BASE_COMMON_TEXT_OURRECOMMEND', 'Our Recommendations');

define('BASE_HEAD_ACCOUNT_TITLE', 'My Account');
define('BASE_HEAD_ACCOUNT_VIEW_ORDERS', 'View Orders');
define('BASE_HEAD_ACCOUNT_ACCOUNT_SETTING', 'Account Settings');
define('BASE_HEAD_ACCOUNT_MANAGE_ADDRESS', 'Manage Address Book');

define('BASE_HEAD_ORDER_STATUS_TITLE', 'Order Status');

define('BASE_HEAD_HELP_TITLE', 'Help');
define('BASE_HEAD_HELP_SUBMIT', 'Submit a Request');
define('BASE_HEAD_HELP_KNOWLEDGE', 'Knowledgebase');

define('BASE_HEAD_CURRENCIES_TITLE', 'Currencies');

define('BASE_HEAD_CHANGETHEMES_TITLE', 'Change Themes');
