...
define('EMAIL_GREET_MR', 'Dear Friend %s,' . "\n\n");
define('EMAIL_GREET_MS', 'Dear Friend %s,' . "\n\n");
define('EMAIL_GREET_NONE', 'Dear %s' . "\n\n");

// First line of the greeting
define('EMAIL_WELCOME', 'Welcome to be a member of <strong>' . STORE_NAME . '</strong>.');
...
define('EMAIL_CONTACT', 'If you need further information about our products or you have any question, please feel free to email us at <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">'. STORE_OWNER_EMAIL_ADDRESS .' </a>. You will enjoy our 100% satisfied service.'. "\n\n");
