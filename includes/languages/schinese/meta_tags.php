...
// Custom Keywords
define('CUSTOM_KEYWORDS', 'Replica Watches,Replica Chanel Watches');

// Home Page Only:
  define('HOME_PAGE_META_DESCRIPTION', HOMEPAGE_DESCRIPTION);
  define('HOME_PAGE_META_KEYWORDS', HOMEPAGE_KEYWORDS);
  define('HOME_PAGE_TITLE', HOMEPAGE_TITLE);
