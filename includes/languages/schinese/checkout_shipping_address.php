...
define('HEADING_TITLE', 'Choose a shipping address');

define('CHECKOUT_SHOPPPING_ADDRESS_DESCRIPTION', 'Is the address you\'d like to use displayed below? If so,click the corresponding "Ship to the address" button.Or you can.<br/>');

define('ENTER_NEW_SHIPPING_TEXT','Enter a new shipping address.');

define('TABLE_HEADING_SHIPPING_ADDRESS', 'Shipping Address');
define('TITLE_SHIPPING_ADDRESS', 'Current Shipping Address');
define('TITLE_BILLING_ADDRESS', 'Your Billing Address:');

define('TABLE_HEADING_ADDRESS_BOOK_ENTRIES', '...Or Choose From Your Address Book Entries');
define('TITLE_PLEASE_SELECT', 'Or enter a new shipping address');
