...
define('TEXT_CHOOSE_SHIPPING_DESTINATION', '<span class="red">Dropship customers:</span> Please copy this shipping address into your paypal shipping address when you pay for this order.');
