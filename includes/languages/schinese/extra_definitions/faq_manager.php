...
//
define('BOX_HEADING_FAQ_CATEGORIES_CSS', '知识库');
define('FAQ_CATEGORIES_CSS_SEARCH_TEXT','搜索您的提问');

define('BOX_HEADING_FAQ_CATEGORIES', 'FAQ类别');
define('BOX_HEADING_WHATS_NEW', '最新提问');
define('FAQ_CATEGORIES_BOX_HEADING_WHATS_NEW', 'New FAQs ...');
define('BOX_HEADING_FEATURED_FAQS', '推荐');
...
define('TEXT_NO_ALL_FAQS', '我们将会添加更多的帮助信息，感谢支持本站');
define('TEXT_NO_SEARCH_RESULT', '没有相关内容');
...
define('FAQ_CATEGORY_PERSONAL', '您的个人信息');
define('FAQ_CATEGORY_ADDRESS', '您的地址');
define('FAQ_CATEGORY_CONTACT', '您的联系信息');
