...
//
  ...
  define('MODULE_PAYMENT_WIRE_MARK_BUTTON_IMG', 'includes/templates/chanelwatches/images/checkout/ico_Wire.gif');
  ...
  define('MODULE_PAYMENT_WIRE_TEXT_NOTICE',' Please E-mail your order number, amount, sender\'s first and last name, sender\'s country, sender\'s phone number to us after your send the payment by wire transfer. Thanks!');
