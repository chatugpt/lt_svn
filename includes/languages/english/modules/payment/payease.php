...
//
  ...
  define('MODULE_PAYMENT_PAYEASE_TEXT_ADMIN_TITLE', 'PAYEASE Payment Gateway');
  define('MODULE_PAYMENT_PAYEASE_TEXT_CATALOG_TITLE', 'PAYEASE Payment Gateway');
  define('MODULE_PAYMENT_PAYEASE_TEXT_DESCRIPTION', 'PAYEASE Payment Gateway');

  define('MODULE_PAYMENT_PAYEASE_MARK_BUTTON_IMG', DIR_WS_MODULES . '/payment/payease/payease.gif');
  define('MODULE_PAYMENT_PAYEASE_MARK_BUTTON_ALT', 'PayEase Payment Service');
  define('MODULE_PAYMENT_PAYEASE_ACCEPTANCE_MARK_TEXT', 'PayEase Payment Service');

  define('MODULE_PAYMENT_PAYEASE_TEXT_CATALOG_LOGO', '<img src="' . MODULE_PAYMENT_PAYEASE_MARK_BUTTON_IMG . '" alt="' . MODULE_PAYMENT_PAYEASE_MARK_BUTTON_ALT . '" title="' . MODULE_PAYMENT_PAYEASE_MARK_BUTTON_ALT . '" /> &nbsp;' .  '<span class="smallText">' . MODULE_PAYMENT_PAYEASE_ACCEPTANCE_MARK_TEXT . '</span>');
