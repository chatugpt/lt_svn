...
//
  ...
  define('MODULE_PAYMENT_WESTERNUNION_RECEIVER_NOTICE', ' Please Email your order number, the western union control number, amount, sender\'s first and last name, sender\'s address and country, sender\'s phone number to us after your send payment by western union. Thanks!');
