...
//  
  ...
  define('BOX_HEADING_SUBSCRIBE', 'Newsletter<br/><span class="b_"></span>'); // sidebox title
  
  define('BUTTON_IMAGE_SUBSCRIBE', 'button_subscribe.gif');
  define('BUTTON_SUBSCRIBE_ALT', 'Subscribe');
  define('BOX_SUBSCRIBE_DEFAULT_TEXT', 'for the latest offers, discount and site activity!');
