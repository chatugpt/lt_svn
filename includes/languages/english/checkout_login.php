...
define('HEADING_TITLE', '<span class="red">Login</span> or Create an account');

define('HEADING_NEW_CUSTOMER', 'New Guests');
...
define('HEADING_RETURNING_CUSTOMER', 'Returning Guests');
