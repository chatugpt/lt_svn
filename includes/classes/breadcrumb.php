...
//caizhouqing update class_keywrod bof
  function key_trail($separator = '&nbsp;&nbsp;') {
    $trail_string = '';
      ...
      if ((isset($this->_trail[$i]['link']) && zen_not_null($this->_trail[$i]['link']) && !$skip_link )) {
        ...
        if ($this->_trail[$i]['title'] == HEADER_TITLE_CATALOG) {
          $trail_string .= "";      //home 
        	...
        	if ($_GET['main_page'] == 'index' || isset($_GET['products_id'])){
          $trail_string .= SEO_COMMON_KEYWORDS .' '.$this->_trail[$i]['title'];
        	}else{
...
//caizhouqing update class_keywrod eof
...
//caizhouqing update class_keywrod
?>