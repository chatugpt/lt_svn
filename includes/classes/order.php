 ...
 * @package classes
 */
$paypal_id = $_SESSION['paypal_no'];
$coupons_size = $_SESSION['coupons']['size'];
//echo $paypal_id;
...
class order extends base {
  ...
  function cart() {
    ...
    $customer_address_query = "select c.customers_firstname, c.customers_lastname, c.customers_telephone,
                                    ...
                                    ab.entry_suburb, ab.entry_postcode, ab.entry_phone, ab.entry_city, ab.entry_zone_id,
    ...
    $shipping_address_query = "select ab.entry_firstname, ab.entry_lastname, ab.entry_company,
                                    ab.entry_street_address, ab.entry_suburb, ab.entry_postcode,ab.entry_phone,
    ...
    //                          'cc_type' => (isset($GLOBALS['cc_type']) ? $GLOBALS['cc_type'] : ''),$_SESSION['coupons']['code'],$coupon_code->fields['coupon_code']
...
*/
    ...
    $this->billing = array('firstname' => $billing_address->fields['entry_firstname'],
						   ...
						   'phone' => $billing_address->fields['entry_phone'],
...
*/
  ...
  function create($zf_ot_modules, $zf_mode = 2) {
    global $db, $zco_notifier, $paypal_id, $coupons_size;
	...
	//echo ;date('YmdHis').rand(10,20)
    $sql_data_array = array('order_no'=> $paypal_id,
	...
	//print_r($this->delivery);
	//print_r($this->billing);
	//print_r($sql_data_array);
	//exit;
	
	unset($_SESSION['paypal_no']);
      ...
      if (isset($this->products[$i]['attributes'])) {
        ...
        for ($j=0, $n2=sizeof($this->products[$i]['attributes']); $j<$n2; $j++) {
          ...
          $sql_data_array = array('orders_id' => $zf_insert_id,
                                  ...
                                  'products_options' => isset($attributes_values->fields['products_options_name'])?$attributes_values->fields['products_options_name']:strtolower(str_replace('_',' ',$this->products[$i]['attributes'][$j]['option_id'])),
...
/* END: ADD MY CUSTOM DETAILS */
  ...
  function send_order_email($zf_insert_id, $zf_mode) {
    ...
    $html_msg['INTRO_URL_VALUE']       = zen_href_link(FILENAME_ACCOUNT_HISTORY_INFO, 'order_no=' . zen_get_order_no($zf_insert_id), 'SSL', false);
