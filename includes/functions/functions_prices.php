    ...
    if ($display_special_price) {
      ...
      if ($display_sale_price && $display_sale_price != $display_special_price) {
        ...
        if ($product_check->fields['product_is_free'] == '1') {
		  ...
		  if($_GET['main_page']=='product_info'){
          $show_sale_price = number_format($display_sale_price,2);
		  }else{
      ...
      if ($display_sale_price) {
	    if($_GET['main_page']!='product_info'){
        $show_normal_price = '<span class="del">' . $currencies->display_price($display_normal_price, zen_get_tax_rate($product_check->fields['products_tax_class_id'])) . ' </span>';
		}
        $show_special_price = '';
		if($_GET['main_page']=='product_info'){
        $show_sale_price = number_format($display_sale_price,2);
        ...
        if ($product_check->fields['product_is_free'] == '1') {
		  ...
		  if($_GET['main_page']=='product_info'){
          $show_normal_price = '<span class="productSalePrice pad_c">' . number_format($display_normal_price,2). '</span>';
		  }else{
