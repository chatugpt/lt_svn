...
<br class="clear"/>
<div class="pad_10px fr"><?php echo '<a href="javascript:popupWindow(\'' . zen_href_link(FILENAME_FAQS_SUBMIT, '', 'NONSSL') . '\')">' . zen_image_button(BUTTON_IMAGE_SUBMIT_FAQ, BUTTON_SUBMIT_FAQ_ALT) . '</a>'; ?></div>
