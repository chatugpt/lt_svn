...
require(DIR_WS_INCLUDES . zen_get_module_directory('checkout_shipping_address_save.php'));
...
// if the customer is not logged on, redirect them to the login page
   ...
   */
   if (isset($_POST['action']) && $_POST['action'] == 'createShipping' && $_POST['address'] == 0) {
   	//----
	$state = zen_db_prepare_input($_POST['state']);
	$zone_id = zen_db_prepare_input($_POST['zone_id']);
	//----
	
	$address_format_query = "insert into address_book(customers_id,entry_gender,entry_firstname,entry_lastname,entry_street_address,entry_suburb,entry_postcode,entry_city,entry_country_id,entry_zone_id,entry_phone,entry_state) values ('".$_SESSION['customer_id']."','".$_POST['gender']."','".$_POST['firstname']."','".$_POST['lastname']."','".$_POST['street_address']."','".$_POST['suburb']."','".$_POST['postcode']."','".$_POST['city']."','".$_POST['zone_country_id']."','".$_POST['zone_id']."','".$_POST['phone']."','".$state."')";
    ...
    //include('includes/checkout_shipping_address_save.php');
/**
 * Address deletes
 */
...
if (isset($_POST['action']) && $_POST['action'] == 'update') {
    ...
    if ($_POST['action'] == 'update') {
      ...
      $sql_data_array[] = array('fieldName'=>'customers_id', 'value'=>$_SESSION['customer_id'], 'type'=>'integer');   //caizhouqing
