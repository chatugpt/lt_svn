...
var shipping_info='<h2 class="blue">Payment methods available in LittleCoral.com:</h2><dl class="dl_dot pad_10px"><dt>PayPal</dt><!--del google checkout<dt>Google Checkout</dt>--><dt>Western Union</dt><dt>Wire Transfer</dt></dl><div>Time of transit varies depending on where you\'re <BR/>located and where your package is coming from.</div>';

var payment_option='<h2 class="blue">Shipping Methods:</h2><div class="margin_t red">When you place an order with LittleCoral.com, you<BR/>are emailed a confirmation of your order. <BR/>Once your order is shipped, you\'ll receive an email with the tracking information for your order\'s shipment. You can choose whichever method suits you best when you place an order. LittleCoral.com offers two different international shipping methods:</div><dl class="dl_dot pad_10px"><dt>Standard shipping: Normally takes 7 to 10 days.</dt><dt>Express Shipping: Normally takes 2 to 4 days</dt></dl><div>Time of transit varies depending on where you\'re located and where your package is coming from.</div>';
