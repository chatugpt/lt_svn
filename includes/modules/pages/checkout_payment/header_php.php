...
$zco_notifier->notify('NOTIFY_HEADER_START_CHECKOUT_PAYMENT');
 ...
 if(!empty($_SESSION['gv_methods_array'])){    //Morrowind Add
	$_SESSION['shipping']['id']= $_SESSION['gv_methods_array']['id'];
	$_SESSION['shipping']['title']= $_SESSION['gv_methods_array']['title'];
	$_SESSION['shipping']['cost']= $_SESSION['gv_methods_array']['cost'];
