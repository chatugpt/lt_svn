...
<?php
 ...
 if ($recently_sold->RecordCount()>0){
	  ...
	  $rs = $db->Execute("select specials_new_products_price,products_id from specials where products_id=".$recently_sold->fields['products_id']." and status=1");  //liuyi update specials price
...
<!--
      ...
      var speed = 10;
      var timer;
      var n1 = document.getElementById("recently_sold_items");
      var n2 = document.getElementById("recently_sold_items_a");
      var n3 = document.getElementById("recently_sold_items_b");
