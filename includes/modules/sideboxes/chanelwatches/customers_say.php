...
//
   $customersSay = $db->ExecuteRandomMulti("SELECT r1.`customers_name`, r.`reviews_text`, r.`reviews_id`, r.`languages_id`, l.`name`, l.`image`, l.`directory` FROM reviews_description r, reviews r1, languages l
WHERE r1.reviews_id=r.reviews_id AND r1.`status` =1 AND l.languages_id=r.languages_id ORDER BY date_added DESC;",3);
