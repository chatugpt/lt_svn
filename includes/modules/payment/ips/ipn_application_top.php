...
// +----------------------------------------------------------------------+
// $Id: ipn_application_top.php 001 2009-05-02 00:00:00 Jack $
//
...
if (MODULE_PAYMENT_IPS_IPN_DEBUG == 'Yes') mail(MODULE_PAYMENT_IPS_DEBUG_EMAIL_ADDRESS,'IPN DEBUG MESSAGE', '0.0. in app top ' . $PHP_SELF);
...
if (MODULE_PAYMENT_IPS_IPN_DEBUG == 'Yes') mail(MODULE_PAYMENT_IPS_DEBUG_EMAIL_ADDRESS,'IPN DEBUG MESSAGE', '0.1. Got past Configuration Load ' . $PHP_SELF);
...
if (MODULE_PAYMENT_IPS_IPN_DEBUG == 'Yes') mail(MODULE_PAYMENT_IPS_DEBUG_EMAIL_ADDRESS,'IPN DEBUG MESSAGE', '0.2. Session Start ' . $PHP_SELF);
...
if (MODULE_PAYMENT_IPS_IPN_DEBUG == 'Yes') mail(MODULE_PAYMENT_IPS_DEBUG_EMAIL_ADDRESS,'IPN DEBUG MESSAGE', '0.3. Got past language loads ' . $PHP_SELF);
