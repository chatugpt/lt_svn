...
function update_status() {
   ...
   function selection() {
     return array('id' => $this->code,
                   ...
                   'info'=>'<ul><li><b>First Name:</b>'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_FIRST_NAME.'</li>'.
						   ...
						   '<li><b>Zip Code:</b>'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_ZIP.'</li>'.
						   '<li><b>City:</b>'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_CITY.'</li>'.
						   '<li><b>Country:</b>'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_COUNTRY.'</li>'.
