 ...
 * @version $Id: upszones.php 6347 2007-05-20 19:46:59Z ajeh $
 */
/*
...
// shipping adjustment
        ...
        if ($shipping == -1) {
          ...
          switch (MODULE_SHIPPING_UPSZONES_METHOD) {
              ...
              $shipping_cost = ($shipping * 1) + constant('MODULE_SHIPPING_UPSZONES_HANDLING_' . $dest_zone);
              break;
        	  case (MODULE_SHIPPING_UPSZONES_METHOD == 'Price'):
    ...
    function keys() {
      $keys = array('MODULE_SHIPPING_UPSZONES_STATUS', 'MODULE_SHIPPING_UPSZONES_METHOD', 'MODULE_SHIPPING_UPSZONES_TAX_CLASS', 'MODULE_SHIPPING_UPSZONES_TAX_BASIS', 'MODULE_SHIPPING_UPSZONES_SORT_ORDER', 'MODULE_SHIPPING_UPSZONES_SKIPPED');
