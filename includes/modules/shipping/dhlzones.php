          ...
          switch (MODULE_SHIPPING_DHLZONES_METHOD) {
              ...
              if (ceil($shipping_weight*1000)/1000 <= $zones_table[$i]) {
                ...
                case (1):
                  ...
                  break;
                case (2):
                  $show_box_weight = ' (' . number_format($shipping_weight * $shipping_num_boxes,2) . MODULE_SHIPPING_DHLZONES_TEXT_UNITS . ')';
                  break;
                default:
                  $show_box_weight = ' (' . $shipping_num_boxes . ' x ' . number_format($shipping_weight,2) . MODULE_SHIPPING_DHLZONES_TEXT_UNITS . ')';
                  break;
                }

//                $shipping_method = MODULE_SHIPPING_DHLZONES_TEXT_WAY . ' ' . $dest_country . (SHIPPING_BOX_WEIGHT_DISPLAY >= 2 ? ' : ' . $shipping_weight . ' ' . MODULE_SHIPPING_DHLZONES_TEXT_UNITS : '');
...
// shipping adjustment
        ...
        if ($shipping == -1) {
          ...
          switch (MODULE_SHIPPING_DHLZONES_METHOD) {
              ...
              $shipping_cost = ($shipping * 1) + constant('MODULE_SHIPPING_DHLZONES_HANDLING_' . $dest_zone);
              break;
        	  case (MODULE_SHIPPING_DHLZONES_METHOD == 'Price'):
