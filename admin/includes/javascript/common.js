...
{ 
	...
	if(width > height){
		if(width>150){ 
			imgObj.width=150;
			imgObj.height=imgObj.height/(imgObj.width/150);
			imgObj.style.marginTop=(150-imgObj.height)/2;
			imgObj.style.marginBottom=(150-imgObj.height)/2;
		}
	}else{
		if(height>150){
			imgObj.height=150; 
			imgObj.width=imgObj.width/(imgObj.height/150); 		
		}		
	}
} 
