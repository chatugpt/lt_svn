...
*/
function zen_define_page_content($id) {
	global $db;
	$sql = "SELECT `pages_html_text` FROM ".TABLE_EZPAGES." WHERE `pages_id` = {$id}";
...
// get products type
  ...
  function zen_draw_admin_box($zf_header, $zf_content) {  //caizhouqing update menu
