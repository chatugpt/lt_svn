 ...
 */
  ...
  if (isset($_POST['edit_x']) || isset($_POST['edit_y'])) {
    ...
    $sql_data_array = array('products_quantity' => $products_quantity,
                            ...
                            'products_price_retail' => zen_db_prepare_input($_POST['products_price_retail']),
                            'products_price_sample' => zen_db_prepare_input($_POST['products_price_sample'])
                            );
...
if(FACEBOOK_ENABLE === 'true') {
//the autofacebook plugin
//AutoFacebook
    $store_name = STORE_NAME; // store name i.e. "Mary's Car Shop", or "MikesCupcakes.com."
    $store_url = HTTP_SERVER; //path to your store without the trailing "/"
    ...
    $appapikey = FACEBOOK_APPAPIKEY;
    $appsecret = FACEBOOK_APPSECRET;
    $user_id = FACEBOOK_USERID;   //id of your facebook store page
    $infinite_session_key = FACEBOOK_SESSIONKEY; //from facebook app
