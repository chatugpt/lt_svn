...
if (menu_header_visible('Configuration')=='true') {
?>
<!-- configuration //-->
<li class="submenu">
...
<?php
  ...
  if (1 == 1) {
    ...
    while (!$configuration_groups->EOF) {
      if (page_allowed($configuration_groups->fields['cgTitle'])=='true')$cfg_groups .= '<li><a href="' . zen_href_link(FILENAME_CONFIGURATION, 'gID=' . $configuration_groups->fields['cgID'], 'NONSSL') . '">' . $configuration_groups->fields['cgTitle'] . '</a></li>' . "\n";
