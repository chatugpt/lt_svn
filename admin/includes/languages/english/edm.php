...
define('HEADING_TITLE', 'EDM');

define('TEXT_CUSTOMER', 'Customer:');
define('TEXT_SUBJECT', 'Subject:');
define('TEXT_FROM', 'From:');
define('TEXT_FROMNAME', 'From Name:');
...
define('TEXT_HOST', 'SMTP host:');
define('TEXT_PORT', 'SMTP port:');
define('TEXT_SSL', 'SSL?');
define('TEXT_SEPERATE', 'Seperate：');
define('TEXT_USER', 'SMTP user：');
define('TEXT_PASS', 'SMTP password：');
define('TEXT_SPAN', 'Time span：');

define('ERROR_EDM_TOOMUCH', 'Too many emails!you can send not more than %s emails');
?>