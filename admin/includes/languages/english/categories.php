...
define('TEXT_EDIT_CATEGORIES_BANNER_IMAGE', 'Category Banner Image:');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_CATEGORIES_TYPES', '<strong>Choose Categories types:</strong>');
  define('TEXT_CATEGORIES_TYPES_1', 'Normal');
  define('TEXT_CATEGORIES_TYPES_2', 'Featured Categories');
  define('TEXT_CATEGORIES_TYPES_3', 'Shopping by Categories');
	
  define('TEXT_CATEGORIES_DISPLAY_TYPES', '<strong>Choose Categories Display types:</strong>');
  define('TEXT_CATEGORIES_DISPLAY_TYPES_1', 'Categories List');
  define('TEXT_CATEGORIES_DISPLAY_TYPES_2', 'Product List');
  define('TEXT_CATEGORIES_DISPLAY_TYPES_3', 'Clean Product List');

  define('TEXT_PRODUCT_LIST_TYPES', '<strong>Choose Products List Display types:</strong>');
  define('TEXT_PRODUCT_LIST_TYPES_1', 'List');
  define('TEXT_PRODUCT_LIST_TYPES_2', 'Grid');
  define('TEXT_PRODUCT_LIST_TYPES_3', 'Gallery');
...
define('TEXT_CATEGORIES_BOTTOM_DESCRIPTION', 'Categories Bottom Description:');
 ...
 */
	...
	define('TEXT_CATEGORIES_BANNER_LINK_FIRST','banner 1 link (Contain "http://")');
	define('TEXT_CATEGORIES_BANNER_LINK_SECOND','banner 2 link (Contain "http://")');
	define('TEXT_BANNER1_IMAGES_DELETE', '<strong>Delete Banner1 Image?</strong> NOTE: Removes Banner 1 Image from Product, Image is NOT removed from server:');
	define('TEXT_BANNER2_IMAGES_DELETE', '<strong>Delete Banner2 Image?</strong> NOTE: Removes Banner 2 Image from Product, Image is NOT removed from server:');
