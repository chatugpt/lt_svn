...
define('EMAIL_DISCLAIMER', 'If you need further information about our products or you have any question, please feel free to email us at <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">'. STORE_OWNER_EMAIL_ADDRESS .' </a>. You will enjoy our 100% satisfied service.\n\n This email address was given to us by you or by one of our customers. If you feel that you have received this email in error, please send an email to %s');

define('EMAIL_TEXT_STATUS_UPDATE', 'Your order has been updated to the following status.' . "\n\n" . 'New status: %s' . "\n\n" . 'If you need further information about our products or you have any question, please feel free to email us at <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '"> . You will enjoy our 100% satisfied service. ' . "\n\n");
