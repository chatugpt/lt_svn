...
define('TEXT_PRODUCTS_SAMPLE_PRICE_NET', 'Products Sample Price (Net):');
define('TEXT_PRODUCTS_SAMPLE_PRICE_GROSS', 'Products Sample Price (Gross):');
...
//wholesale
  define('TEXT_WHOLESALE_ONLY','Only Wholesale:');
  define('TEXT_PRICE_RETAIL_NET', 'Products Retail Price(Net):');
  define('TEXT_PRICE_RETAIL_GROSS', 'Products Retail Price(Gross):');
