...
define('MODULES_SHIPPING_HEAD_TITLE', 'Shipping');
define('MODULES_PAYMENT_HEAD_TITLE', 'Payment');
define('MODULES_ORDERTOTAL_HEAD_TITLE', 'Order Total');

define('HEADER_ALT_TEXT', 'Admin Powered by VGoldZone');
...
define('BOX_TOOLS_DEFINE_SHIPPINGINFO','About Dropship');
...
// search filters
  ...
  define('HEADING_TITLE_SEARCH_FILTER','Group Filter: ');
