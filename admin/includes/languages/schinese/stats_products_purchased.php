...
define('TABLE_HEADING_PRODUCTS_QUANTITY', '剩余数量');
define('TABLE_HEADING_PRODUCTS_NAME', '产品');
define('TABLE_HEADING_PRODUCTS_MODEL', '模型');
?>