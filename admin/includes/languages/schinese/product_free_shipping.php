...
define('TEXT_PRODUCT_MORE_INFORMATION', '想了解更多信息，请参观该商品 <a href="http://%s" target="blank">网页</a>.');
define('TEXT_PRODUCT_DATE_ADDED', '这产品加入我们的目录上 %s.');
define('TEXT_PRODUCT_DATE_AVAILABLE', '此产品将在库存上 %s.');
...
define('TEXT_DELETE_PRODUCT_INTRO', '您确定要永久删除此产品?<br /><br /><strong>警告 :</strong> 在相关联产品<br /> 1确保主类别已被更改，如果你正在删除从主产品类别<br /> 2检查的复选框删除的类别产品从');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_INFO_HEADING_ATTRIBUTE_FEATURES','对于产品属性ID的变化 ID# ');
