 ...
 */
  ...
  //cx update
  $bestYouArray[] = array("id" => "8", "text" => "All Customers");
...
//test
  function changegroupfilter(obj, sort_url){
  	  if(obj.value==8)
	  {
	  	window.location.href = "customers.php";//this is all type ...
	  }
	  else if(obj.value != '-1')
	  {
...
<?php
  if ($error == true) {
    if ($entry_email_address_error == true) {
      ...
      echo zen_dn_draw_input_field('customers_email_address', $cInfo->customers_email_address, zen_set_field_length(TABLE_CUSTOMERS, 'customers_email_address', 50)) . '&nbsp;' . ENTRY_EMAIL_ADDRESS_ERROR_EXISTS;
    } else {
...
<?php } ?>
      ...
      <tr>
        <td class="formArereaTitle"><?php echo CATEGORY_OPTIONS; ?></td>
      </tr>
      <tr>
        <td class="formArea"><table border="0" cellspacing="2" cellpadding="2">
...
//    zen_redirect(zen_href_link(FILENAME_CUSTOMERS, 'cID=' . $_GET['cID'] . (isset($_GET['page']) ? '&page=' . $_GET['page'] : ''), 'NONSSL'));
    ...
    while (!$customers->EOF) {
      $sql = "select customers_info_date_account_created as date_account_created,customers_info_id as customers_id,
...
?>
                ...
                <td class="dataTableContent"><?php echo $customers->fields['customers_firstname']; ?><br></td>
                <td class="dataTableContent"><?php echo customerTypes($customers->fields['customers_describes']); ?> || <?php echo $customers->fields['customers_email_address']; ?></td>
