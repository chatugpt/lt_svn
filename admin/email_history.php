...
*/
  ...
  if ($action == 'trim_confirm') {
        $age = $_GET['email_age'];
        if ($age == '1_months') {
          $cutoff_date = date("m-d-Y", mktime(0, 0, 0, date("m") - 1, date("d"), date("Y")));
        }
        if ($age == '6_months') {
          $cutoff_date = date("m-d-Y", mktime(0, 0, 0, date("m") - 6, date("d"), date("Y")));
        }
        elseif ($age == '1_year') {
          $cutoff_date = date("m-d-Y", mktime(0, 0, 0, date("m"), date("d"), date("Y") - 1));
        }
