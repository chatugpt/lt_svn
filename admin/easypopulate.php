...
$ep_act = isset($_GET['act']) ? $_GET['act'] : '';
...
<?php } ?>
										<br />
										<a href="easypopulate.php?download=stream&dltype=full&act=pure">下载<b>完整的</b>.csv文件（仅结构）</a><br />
										...
										<br /><br />
										<b>在临时目录中创建批量和Froogle文件: <a href="../<?php echo $tempdir; ?>"><?php echo $tempdir; ?></a></b>
										<br /><br />
...
<?php } ?>
										<br />
										<a href="easypopulate.php?download=tempfile&dltype=full&act=pure">在临时目录中创建 <b>完整的</b> .csv文件（仅结构）</a><br />
